...
const testimonials = [
  {
    ...
    name: "YiMing",
    tag: "yimingdothan",
    description: `v0 + SaaS Kit + chatgpt for graphics
...
… look no further than SaaS Kit[0] by 
...
`,
  ...
  },
  {
    ...
    name: "shadcn",
    tag: "shadcn",
    description: `4/n - Finally, a custom theme from SaaS Kit by @iamsahaj_xyz`,
...
Build a color palette, typography and layout preview with SaaS Kit dot com
...
Grab  the CSS → drop into Bolt = cohesive design`,
  ...
  },
  {
    ...
    tag: "JollyTanpreet",
    description:
      "I just tried SaaS Kit and seems like you nailed it. This is what I have been looking for, awesome job!",
  ...
  },
  {
    ...
    tag: "YTCodeAntonio",
    description: "there is an entire chapter dedicated to SaaS Kit!! such a cool project",
  ...
  },
  {
    ...
    name: "Emir",
    tag: "emirthedev",
    description: "Started using SaaS Kit for client projects too. This is a real game changer",
  ...
  },
  {
    ...
    tag: "elithrar",
    description: `used this shadcn theme editor to make it a little less plain: SaaS Kit.com`,
